...
used with together with [`vl-source-vector`](vector-source.md) component.
...
Example below shows how you can use `vl-layer-vector` and [`vl-source-vector`](vector-source.md) to render some 
