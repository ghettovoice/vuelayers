...
raster source, like [`vl-source-image-static`](image-static-source.md).
...
Example below shows how to use `vl-layer-image` component together with [`vl-source-image-static`](image-static-source.md)
